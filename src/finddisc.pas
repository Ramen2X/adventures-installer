...
const
	UniqueFile = 'DATA\DISK\LEGO1D.DLL';
...
begin
	...
	begin
		MsgBox('No CD-ROM drives were detected. The installer will now close.', mbError, MB_OK);
		Abort;
	end;
	...
	begin
		...
		begin
			if MsgBox('Please insert the CD-ROM and run the installer again.', mbConfirmation, MB_OKCANCEL or MB_DEFBUTTON1) = IDOK then
